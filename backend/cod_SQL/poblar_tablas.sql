...
INSERT INTO Usuarios (nombre, correo, contrasena, tipoUsuario) VALUES
('Carlos', 'carlos@example.com', 'password123', 'jefe'),
('Maria', 'maria@example.com', 'securepass', 'jefe'),
...
INSERT INTO restaurante (jefe, aforo, fotos, URLweb, telefono, descripcion, visitas, email, nombre) VALUES
 ('Maria', 80, 'fotos/maria_restaurante.jpg', 'http://mariarestaurante.com', 987654321, 'Authentic Italian dishes', 800, 'info@mariarestaurante.com', 'Maria Restaurante');
INSERT INTO restaurante (jefe, aforo, fotos, URLweb, telefono, descripcion, visitas, email, nombre) VALUES
 ('Juan', 60, 'fotos/juan_restaurante.jpg', 'http://juanrestaurante.com', 654123987, 'Modern Mexican cuisine', 600, 'info@juanrestaurante.com', 'Juan Restaurante');
 INSERT INTO restaurante (jefe, aforo, fotos, URLweb, telefono, descripcion, visitas, email, nombre) VALUES
 ('Ana', 70, 'fotos/ana_restaurante.jpg', 'http://ana_restaurante.com', 654123456, 'Traditional Spanish dishes', 450, 'info@ana_restaurante.com', 'Ana Restaurante');   

-- Insert data into reseñas
INSERT INTO resenas (fecha, texto, valoracion, comentarista, local) VALUES
('2024-01-01', 'La comida estuvo excelente, lo recomiendo mucho.', 5, 'Juan', 1),
('2024-02-15', 'El servicio fue malo, pero la comida fue decente.', 3, 'Ana', 2);
